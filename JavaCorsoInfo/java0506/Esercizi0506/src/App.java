            ...
            case 3:
                ...
                for (Animale animale : animali) {
                    if (animale.getNome().equalsIgnoreCase(nomeAnimale)) {
                        ...
                        Veterinario veterinario = new Veterinario(nomeVeterinario, cognomeVeterinario, etaVeterinario,
                                "Veterinario", specializzazioneVeterinario);
                        veterinario.visitaAnimale(animale);
                        System.out.println("Visita completata per " + animale.getNome() + " da parte del veterinario "
                                + veterinario.getNome() + ".");
                    }
                }
